...
use AriMoralesJordan\LaravelAppCast\Contracts\TerminableRepository;
use AriMoralesJordan\LaravelAppCast\EntryUpdate;
use AriMoralesJordan\LaravelAppCast\IncomingEntry;
use AriMoralesJordan\LaravelAppCast\Jobs\ProcessPendingUpdates;
use Closure;
use Exception;
