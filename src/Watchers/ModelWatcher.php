...
class ModelWatcher extends Watcher
{
    ...
    public function register($app)
    {
        ...
        LaravelAppCast::afterStoring(function () {
            $this->flush();
        });
    }
    ...
    {
        if (! LaravelAppCast::isRecording() || ! $this->shouldRecord($event)) {
            return;
        }
        ...
        LaravelAppCast::recordModelEvent(IncomingEntry::make(array_filter([
    ...
    public function recordHydrations($data)
    {
        ...
        if (! isset($this->hydrationEntries[$modelClass])) {
            ...
            LaravelAppCast::recordModelEvent($this->hydrationEntries[$modelClass]);
        } else {
