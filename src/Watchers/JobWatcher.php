...
class JobWatcher extends Watcher
{
    ...
    public function recordProcessedJob(JobProcessed $event)
    {
        ...
        LaravelAppCast::recordUpdate(EntryUpdate::make(
    ...
    {
        $wasRecordingEnabled = LaravelAppCast::$shouldRecord;

        LaravelAppCast::$shouldRecord = false;

        $command = $this->getCommand($payload['data']);

        if ($wasRecordingEnabled) {
            LaravelAppCast::$shouldRecord = true;
        }
